...
class FeedScreen extends ConsumerWidget {
  ...
  Widget _storyRowWidget(WidgetRef ref) {
    ...
    return ref.watch(getUserByIdController(currentUserId)).when(data: (currentUser){
      return Container(
            ...
            (users){
              ...
              itemBuilder: (context,index){
                return index == 0 ?InkWell(
                  onTap: (){
                    navigatorPush(context, CreateStoryScreen(user: currentUser));
                  },
                  child: Column(
                    children: [
                      Stack(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(  
                              ...
                              image: DecorationImage(image: NetworkImage(currentUser.profileImg),fit: BoxFit.cover)
                            ),
                          ),
                          Positioned(
                            right: -1,
                            ...
                            child: InkWell(
                              ...
                              onTap: (){}, child: Icon(Icons.add_circle,color: Colors.black87)))
                        ],
                      ),
                      SizedBox(height: 6),
                      Text("Your Story")
                 ...
                 InkWell(
                  ...
                  onTap: (){
                     navigatorPush(context, StoryScreen(userId: users[index-1].uid));
                  },
                   child: Column(
                     children: [
                       Container(
                        ...
                        child: Container(
                          ...
                          shape: BoxShape.circle,
                          color: Colors.grey,
                          image: DecorationImage(image: NetworkImage(users[index-1].profileImg),fit: BoxFit.cover)
                        ),
