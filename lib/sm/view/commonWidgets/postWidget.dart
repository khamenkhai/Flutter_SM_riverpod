...
class _PostWidgetState extends ConsumerState<PostWidget> {
  ...
  bool checkSavedPost() {
    return ref.watch(getUserByIdController(currentUserId)).when(data: (data) {
          ...
          children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            MyTextWidget(text: "${post.feeling}", fontSize: 13),
                          ],
                        ),
                        MyTextWidget(
                ...
                : Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            navigatorPush(context, PostImageView(imageUrl: post.postImage.toString(),postId: post.postId));
                          },
                          child: Container(
                            width: double.infinity,
            ...
            post.postDescription != ""
                ? Container(
                    ...
                    child: Row(
                      children: [
                        MyTextWidget(text: "${post.postDescription}"),
                      ],
                    ))
                : Container(),
            ///likes and comments
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    MyTextWidget(text: "${"${post.likes.length}  ${tr(LocaleKeys.lblLikes)}"}",color: Colors.grey,fontSize: 14),

                    SizedBox(width: 10),
                    //total comments
                   MyTextWidget(text: "${"${post.totalComment}  ${tr(LocaleKeys.lblComments)}"}",color: Colors.grey,fontSize: 14),
                  ],
                ),
              ),
            ),
                  ...
                  children: [
                    ListTile(
                      onTap: () {
                        ...
                        navigatorPushReplacement(context, EditPostScreen(post: post));
                      },
                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        title: ref.watch(getUserByIdController(currentUserId)).when(data: (data){
                          return data.followings.contains(post.userId) ? Text("Unfollow this user"):Text("Follow this user");
